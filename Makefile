srcdir = /root/server/php-pgsql-5.4
builddir = /root/server/php-pgsql-5.4
top_srcdir = /root/server/php-pgsql-5.4
top_builddir = /root/server/php-pgsql-5.4
...
prefix = /usr/local
phplibdir = /root/server/php-pgsql-5.4/modules
...
.NOEXPORT:
pgsql.lo: /root/server/php-pgsql-5.4/pgsql.c
	$(LIBTOOL) --mode=compile $(CC)  -I. -I/root/server/php-pgsql-5.4 $(COMMON_FLAGS) $(CFLAGS_CLEAN) $(EXTRA_CFLAGS)  -c /root/server/php-pgsql-5.4/pgsql.c -o pgsql.lo 
